...
import { useDimensions } from "@/components/login-background/hooks/use-debounced-dimensions"
...
const PixelTrail: React.FC<PixelTrailProps> = ({
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      // 🛑 Skip pixel activation if hovering over excluded area
      const overText = (e.target as HTMLElement).closest('[data-no-trail]');
      if (overText) return;
